...
class Image extends Module {
	 ...
	 * @param type $filename filename of the image
	 * @param type $returnSystemPath if true returns a system path, otherwise a web url
	 ...
	 * @param type $overwrite overwrite any existing cached version of this image
	 * @param type $returnSystemPath if true returns a system path, otherwise a web url
	 * @return string system path or a web path
	 */
	 ...
	 * @param type $width desired width
	 * @param type $height desired height
	 * @param type $bgRed red value to fill blank space with
	 * @param type $bgGreen green value to fill blank space with
	 * @param type $bgBlue blue value to fill blank space with
	 * @param type $bgAlpha alpha value to fill blank space with
	 * @param type $overwrite overwrite any existing cached version of this image
	 * @param type $returnSystemPath if true returns a system path, otherwise a web url
	 * @return string system path or a web path
	 */
