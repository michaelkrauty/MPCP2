  ...
  <div class="col-sm-3 col-md-2 sidebar" style="padding-right:0px;padding-left:0px;min-width:230px;">
    <div class='well'>
      <ul class="nav nav-sidebar">
        ...
        <li style="margin-top:5px;"><input class="btn btn-lg btn-info btn-block" type="button" value="Console" onClick="parent.location='manage.php?server=<?php echo $_SESSION["server"]["id"];?>&page=console'" /></li>
        <li style="margin-top:5px;"><input class="btn btn-lg btn-info btn-block" type="button" value="Server Mod" onClick="parent.location='manage.php?server=<?php echo $_SESSION["server"]["id"];?>&page=mod'" /></li>
