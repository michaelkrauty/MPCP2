	...
	?>
		...
		<div class="well">
			<form action="" class="form-signin" method="post">
				...
				<table width="100%">
					<tr>
						<th width="48%"><input class="btn btn-lg btn-success btn-block"
							type="button" value="Register"
							onClick="parent.location='register.php'" />
						
						<th width="4%">
						
						<th width="48%"><input class="btn btn-lg btn-warning btn-block"
							type="button" value="Forgot Password" onClick="" />
